...
void ZoneClass::HandleMovementInput(InputClass* Input, float frameTime)
{
	...
	///  update the CameraClass and TextClass object with the new viewing position
	...
	// press F1 the UI be displayed or not.
...
///Important func
// The Frame function handles the updating loop for the zone and 
// is called every 16.67 milliseconds if we lock to 60 frames per second.
// Any object that needs to be updated each frame is updated in this function.
// And once all the objects have called their frame processing 
// this function will then call the ZoneClass::Render function 
// to do all the drawing of the zone.
