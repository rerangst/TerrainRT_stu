...
void TextClass::Render(ID3D11DeviceContext* deviceContext, ShaderManagerClass* ShaderManager, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
...
void TextClass::RenderSentence(ID3D11DeviceContext* deviceContext, ShaderManagerClass* ShaderManager, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
	D3DXMATRIX orthoMatrix, ID3D11ShaderResourceView* fontTexture)
{
